                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                ...
                                <ul id="" class="nav nav-tabs tabs-pull-left bordered">
                                    ...
                                    <li>
                                        <a href="#agpay" data-toggle="tab" aria-expanded="false">Agreements & Payments</a>
                                    </li>
                                    <li>
                                ...
                                <div id="" class="tab-content">
                                    <div class="tab-pane fade active in" id="general">
                                        <div id="sub_main_tab">
                                        <ul id="" class="nav nav-tabs tabs-pull-left bordered" style="margin: 10px;">
                                            <li class="active">
                                                <a href="#gene" data-toggle="tab" aria-expanded="true">General</a>
                                            </li>
                                            <li>
                                                <a href="#site_owner" data-toggle="tab" aria-expanded="false">Site Owner Details</a>
                                            </li>                                   
                                        </ul>
                                        <div id="" class="tab-content" style="margin: 0px 10px;margin-bottom: 10px;">
                                            <div class="tab-pane fade active in" id="gene">
                                            ...
                                            <div class="tab-pane fade active in" id="site_owner">
                                                <form class="smart-form">
                                                    <fieldset>                                                
                                                        <section class="col-sm-5">
                                                            <label class="ngs_form_label">
                                    ...
                                    <div class="tab-pane fade active in" id="agpay">
                                        <form class="smart-form">
                                            <fieldset>
