                ...
                <article class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget" id="wid-id-4" 
                        ...
                        <header style="margin:0px;">
                            <span class="widget-icon"><?php print (($saq_approvals_obj->id != '') ? '<i class="fa fa-edit"></i>' : '<i class="fa fa-plus"></i>') ?></span>                            			                           
                        </header>
                                    ...
                                    <fieldset>
                                        ...
                                        <label class="select">
                                            <select name="requirement" id="requirement">
                                                <option value="N/A" selected="" disabled="">Please select requirement type</option>
                                                <option value="Compulsory" <?php print (($saq_approvals_obj->requirement == 'Compulsory') ? "selected=''" : "") ?>>Compulsory</option>
                                                <option value="	Optional" <?php print (($saq_approvals_obj->requirement == 'Optional') ? "selected=''" : "") ?>>Optional</option>
                                            </select>
                                        </label>
                                        <label>Approval Name</label>
                                        <label class="input">
                                            <input type="text" id="approval_name" name="approval_name" value="<?php print $saq_approvals_obj->description ?>"/>
                                        </label>
                                        <label>Short Name</label>
                                        <label class="input">
                                            <input type="text" id="short_name" name="short_name" value="<?php print $saq_approvals_obj->code ?>"/>
                                        </label>                                        
                                    </fieldset>
                                    <footer>
