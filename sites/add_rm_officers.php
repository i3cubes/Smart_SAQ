                            ...
                            <div class="widget-body">
                                <form class="smart-form" onsubmit="saveHandler(event)">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <section class="col col-3 ">
                                                <label>Employee &nbsp;<span style="color:red;">(Select employee as RM officer)</span></label>
                                                <label class="select">
                                                    <select name="employee_id" id="employee_id">
                                                        <?php
                                                        $rm_emoployee_obj = new saq_employee();
                                                        $saq_employees = $rm_emoployee_obj->getAll();
                                                        if (count($saq_employees) > 0) {
                                                            foreach ($saq_employees as $emp) {
                                                                
                                                                if ($emp->designtion_id != constants::$admin && $emp->designtion_id != constants::$system_admin) {
                                    ...
                                    <footer>
                                        ...
                                        <input type="hidden" name="option" id="option" value="420"/>
