...
$id = $_REQUEST['id'];
if ($id != '') {
    $saq_district_obj = new saq_district($id);
    $saq_district_obj->getData();

    $heading = "District - $saq_district_obj->name";
}
?>
<style>
    .customFiled {
                ...
                <article class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget" id="" 
                        ...
                        <header style="margin:0px;">
                            <span class="widget-icon"><?php print (($saq_district_obj->id != '') ? '<i class="fa fa-edit"></i>' : '<i class="fa fa-plus"></i>') ?>&nbsp;<?php echo $heading; ?></span>                            			                           
                        </header>
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                <form class="smart-form" onsubmit="saveHandler(event)">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <section class="col col-3 ">
                                                <label>Name</label>
                                                <label class="input">
                                                    <input type="text" id="district_name" name="district_name" value="<?php print $saq_district_obj->name ?>" placeholder="Please enter district name..."/>
                                                </label>
                                    ...
                                    <footer>
                                        <input type="hidden" name="id" id="id" value="<?php print $saq_district_obj->id ?>"/>
                                        <input type="hidden" name="option" id="option" value="<?php print (($saq_district_obj->id != '') ? '222' : '221') ?>"/>
                                        <button class="btn btn-primary">Save &nbsp;<i class="fa fa-save"></i></button>
                                        <?php if ($saq_district_obj->id != '') { ?>
                                            <button type="button" class="btn btn-danger" onclick="deleteHandler(<?php print $saq_district_obj->id ?>)">Delete &nbsp;<i class="fa fa-trash"></i></button> 
                                            <?php } ?>
                                    </footer>
                                </form>
