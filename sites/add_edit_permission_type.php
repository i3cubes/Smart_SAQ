                ...
                <article class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget" id="wid-id-4" 
                        ...
                        <header style="margin:0px;">
                            <span class="widget-icon"><?php print (($saq_permission_type_obj->id != '') ? '<i class="fa fa-edit"></i>' : '<i class="fa fa-plus"></i>') ?></span>                            			                           
                        </header>
                            ...
                            <div class="widget-body">
                                <form class="smart-form" onsubmit="saveHandler(event)">
                                    ...
                                    <footer>
                                        ...
                                        <?php if ($saq_permission_type_obj->id != '') { ?>
                                            <button type="button" class="btn btn-danger" onclick="deleteHandler(<?php print $saq_permission_type_obj->id ?>)">Delete &nbsp;<i class="fa fa-trash"></i></button> 
                                            <?php } ?>
                                    </footer>
                                </form>
