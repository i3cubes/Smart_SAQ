/*! SmartAdmin - v1.4.1 - 2014-06-22 */ !(function () {
    ...
    function d(d, g) {
            ...
            if (!b || !(s - u > p || p > s + u)) {
                ...
                j && l.append(B.canvas),
                    ...
                    h.off(o).one(o, function (a) {
                        ...
                        (b || q) && d === k && j === m && B.setHand(d, j),
                            "hours" === B.currentView
                                ? B.toggleView("minutes", w / 2)
                                : g.autoclose &&
                                  (B.minutesView.addClass("clockpicker-dial-out"),
                                  setTimeout(function () {
                                      B.done();
                                  }, w / 2)),
                            l.prepend(I),
                            clearTimeout(t),
                            e.removeClass("clockpicker-moving"),
                            h.off(n);
                    });
            }
        }
        ...
        (this.id = c("cp")),
            ...
            g.autoclose ||
                f('<button type="button" class="btn btn-sm btn-default btn-block clockpicker-button">' + g.donetext + "</button>")
                    .click(f.proxy(this.done, this))
                    .appendTo(k),
            ("top" !== g.placement && "bottom" !== g.placement) || ("top" !== g.align && "bottom" !== g.align) || (g.align = "left"),
            ("left" !== g.placement && "right" !== g.placement) || ("left" !== g.align && "right" !== g.align) || (g.align = "top"),
            k.addClass(g.placement),
            ...
            A.on("click.clockpicker", f.proxy(this.toggle, this));
        var C,
            D,
            E,
            F = f('<div class="clockpicker-tick"></div>');
        for (C = 0; 24 > C; C += 1) {
    ...
    (d.DEFAULTS = { default: "", fromnow: 0, placement: "bottom", align: "left", donetext: "完成", autoclose: !1, vibrate: !0 }),
        ...
        (d.prototype.show = function () {
            if (!this.isShown) {
                var a = this;
                this.isAppended ||
                    ((e = f(document.body).append(this.popover)),
                    g.on("resize.clockpicker" + this.id, function () {
                        a.isShown && a.locate();
                    }),
                    (this.isAppended = !0));
                ...
                (this.hours = +c[0] || 0),
                    ...
                    this.locate(),
                    (this.isShown = !0),
                    h.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, function (b) {
                        var c = f(b.target);
        ...
        (d.prototype.toggleView = function (a, b) {
            ...
            (this.currentView = a),
                this.spanHours.toggleClass("text-primary", c),
                this.spanMinutes.toggleClass("text-primary", !c),
                e.addClass("clockpicker-dial-out"),
                d.css("visibility", "visible").removeClass("clockpicker-dial-out"),
                this.resetClock(b),
        ...
        (d.prototype.resetClock = function (a) {
            var b = this.currentView,
                ...
                k = this;
            j && a
                ? (k.canvas.addClass("clockpicker-canvas-out"),
                  setTimeout(function () {
        ...
        (d.prototype.setHand = function (a, c, d, e) {
            ...
            if (
                ...
                (g = Math.round(h / k)),
                (h = g * k),
                i ? (12 === g && (g = 0), (g = m ? (0 === g ? 12 : g) : 0 === g ? 0 : g + 12)) : (d && (g *= 5), 60 === g && (g = 0)),
                ...
                (this[this.currentView] = g),
                this[i ? "spanHours" : "spanMinutes"].html(b(g)),
                !j)
            )
                return void this[i ? "hoursView" : "minutesView"].find(".clockpicker-tick").each(function () {
                    var a = f(this);
        ...
        (d.prototype.remove = function () {
            this.element.removeData("clockpicker"),
                ...
                this.isAppended && (g.off("resize.clockpicker" + this.id), this.popover.remove());
        }),
