...
class saq_rate_increment {

    public $id, $name, $status;
    private $table_name = 'saq_rate_increment';
    ...
    public function getAll() {
        ...
        while ($row = dbFetchAssoc($result)) {
            $saq_rate_increment_obj = new saq_rate_increment($row['id']);
            $saq_rate_increment_obj->getData();
            array_push($array, $saq_rate_increment_obj);
        }
        return $array;
    }
